...
/** The screen that contains all the endless gameplay */
export class EndlessGameScreen extends Container implements AppScreen {
    /** A unique identifier for the screen */
    public static readonly SCREEN_ID = 'endless-game';
